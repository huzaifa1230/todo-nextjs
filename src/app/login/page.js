    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-6 shadow-md">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-purple-500">Sign In</h1>
          <p className="mt-2 text-gray-600">Welcome back to Todo App</p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-md border text-black border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-blue-500"
              />
            </div>
            <div>
              <label
